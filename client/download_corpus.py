"""Download UD Russian GSD and build a small corpus file."""
...
def parse_conllu_sentences(text: str) -> list[str]:
    """Parse CoNLL-U into sentences by joining FORM tokens."""
    sentences: list[str] = []
...
def build_corpus(sentences: list[str], limit: int = 300) -> list[str]:
    """Return the first N sentences for the corpus."""
    return sentences[:limit]


def main() -> None:
    """Download raw files and build the small corpus."""
